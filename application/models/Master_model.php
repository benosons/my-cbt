...
class Master_model extends CI_Model {
    ...
    {
        $this->datatables->select('a.id_mahasiswa, a.nama, a.nim, a.email, b.nama_kelas, c.nama_jurusan, d.nama_kategori');
        ...
        $this->datatables->join('kategori d', 'a.kategori_id=d.id_kategori');
        return $this->datatables->generate();
    }
    ...
    {
        $this->datatables->select('a.id_dosen,a.nip, a.nama_dosen, a.email, a.matkul_id, b.nama_matkul, c.nama_kategori, (SELECT COUNT(id) FROM users WHERE username = a.nip OR email = a.email) AS ada');
