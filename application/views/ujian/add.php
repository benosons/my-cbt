<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple hide">
                    <h4>Mata Kuliah <i class="fa fa-book pull-right"></i></h4>
                    <p><?=$matkul->nama_matkul?></p>
                </div>
                <div class="alert bg-purple">
                    <h4>Kategori <i class="fa fa-book pull-right"></i></h4>
                    <p><?=$matkul->nama_kategori?></p>
                </div>
                <div class="alert bg-purple">
                    <h4>Penguji <i class="fa fa-address-book-o pull-right"></i></h4>
                    <p><?=$dosen->nama_dosen?></p>
                </div>
            </div>
            <div class="col-sm-4">
                <?=form_open('ujian/save', array('id'=>'formujian'), array('method'=>'add','dosen_id'=>$dosen->id_dosen, 'matkul_id'=>$matkul->matkul_id, 'kategori_id'=>$dosen->kategori_id))?>
