...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			$master = ["jurusan", "kelas", "matkul", "penguji", "peserta"];
			...
			<li class="treeview <?= in_array($page, $master)  ? "active menu-open" : ""  ?>">
				...
				<ul class="treeview-menu">
					<li class="<?=$page==='jurusan'?"active":""?>" hidden>
						<a href="<?=base_url('jurusan')?>">
							<i class="fa fa-circle-o"></i> 
							Master Jurusan
						</a>
					</li>
					<li class="<?=$page==='kelas'?"active":""?>" hidden>
						<a href="<?=base_url('kelas')?>">
							<i class="fa fa-circle-o"></i>
							Master Kelas
						</a>
					</li>
					<li class="<?=$page==='matkul'?"active":""?>" hidden>
			...
			<li class="treeview <?= in_array($page, $relasi)  ? "active menu-open" : ""  ?>" hidden>
			...
			<?php endif; ?>
			<?php if( $this->ion_auth->is_admin() || $this->ion_auth->in_group('penguji') ) : ?>
			...
			<?php endif; ?>
			<?php if( $this->ion_auth->in_group('penguji') ) : ?>
