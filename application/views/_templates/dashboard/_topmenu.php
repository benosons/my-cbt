<a href="<?=base_url('dashboard')?>" class="logo">
    ...
    <!-- <span class="logo-lg"><img style="margin-left: -20px;" src="<?= base_url('assets/dist/img/gmni.png') ?>" width="25%" > -->
        <span><b>C</b>omputer <b>B</b>ased <b>T</b>est</span>
    <!-- </span> -->
</a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs">Selamat Datang, <?=$user->first_name?></span>
                </a>
