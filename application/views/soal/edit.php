                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="dosen_id" class="control-label">Penguji (Kategori)</label>
                                ...
                                <select required="required" name="dosen_id" id="dosen_id" class="select2 form-group" style="width:100% !important">
                                    ...
                                    <?php 
                                    $sdm = $soal->dosen_id.':'.$soal->kategori_id.':'.$soal->matkul_id;
                                    foreach ($dosen as $d) : 
                                        $dm = $d->id_dosen.':'.$soal->kategori_id.':'.$d->matkul_id;?>
                                        <option <?=$sdm===$dm?"selected":"";?> value="<?=$dm?>"><?=$d->nama_dosen?> (<?=$d->nama_kategori?>)</option>
                                    <?php endforeach; ?>
                                </select>
                                ...
                                <input type="hidden" name="kategori_id" value="<?=$dosen->kategori_id;?>">
                                <input type="text" readonly="readonly" class="form-control" value="<?=$dosen->nama_dosen; ?> (<?=$dosen->nama_kategori; ?>)">
                                <?php endif; ?>
                            </div>
