...
class Dashboard extends CI_Controller {
	...
	public function admin_box()
	{
		$box = [
			...
			[
				'box' 		=> 'olive',
				'total' 	=> $this->dashboard->total('kategori'),
				'title'		=> 'Kategori',
				'icon'		=> 'building-o',
				'view'		=> 'kategori'
			],
	...
	public function index()
	{
		...
		if ( $this->ion_auth->is_admin() ) {
		...
		} elseif ( $this->ion_auth->in_group('penguji') ) {
			$matkul = ['matkul' => 'dosen.matkul_id=matkul.id_matkul'];
			$matkul = ['kategori' => 'dosen.kategori_id=kategori.id_kategori'];
			...
			$join = [
				...
				'kategori d'	=> 'a.kategori_id = d.id_kategori'
			];
